...
var sp = document.querySelector("#createdBy");
sp.innerHTML="Aplicación creada por: Homero";
...
function buildToDo(todo, index) {
  ...
  toDoText.id = index;
  toDoText.addEventListener('click',completeToDo,true);
...
btn.addEventListener('click',addToDo,true);
